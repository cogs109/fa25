...
|--|-----|
| **Prof. Lai** | **• W, 2:30-3:30** (walk-in), **3:30-4pm** ([book](https://calendar.app.google/1nebbtvdYdn6WFpw5)) @ CSB 244/Zoom <br> **•Th, 4:30-5:30pm** ([book](https://calendar.app.google/1nebbtvdYdn6WFpw5) only) on Zoom only |
